                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <div class="right_header_info">
                                    <ul>
                                        <li class="menu_iconb">
                                            <a href="#"><img style="margin-right: 15px;" src="Home/icon/1.png" alt="#" />7213456789</a>
                                        </li>
                                        <li class="menu_iconb">
                                            <a href="login.jsp">Log in <img style="margin-right: 15px;" src="Home/icon/5.png" alt="#" /> </a>
                                        </li>
                                        <li class="menu_iconb">
                                            <a href="../signup.jsp">Signup<img style="margin-left: 15px;" src="Home/icon/6.png" alt="#" /></a>
                                        </li>
                                        <li class="tytyu">
                                                ...
                                                <div class="container">
                                                    <div class="carousel-caption text">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="img_bg">
                                                                    <figure><img src="Home/images/cap.png" /></figure>
                                                                </div>
                                                            </div>
                                                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="footer_top">
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <a href="index.html"> <img class="logo1" src="Home/images/logo1.png" /></a>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <ul class="sociel">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 ">
                                <div class="address">
                                    ...
                                    <ul class="loca">
                                        <li>
                                            <a href="#"><img src="Home/icon/loc.png" alt="#" /></a>145 londone
                                            <br>uk </li>
                                        <li>
                                            <a href="#"><img src="Home/icon/call.png" alt="#" /></a>+12586954775 </li>
                                        <li>
                                            <a href="#"><img src="Home/icon/email.png" alt="#" /></a>demo@gmail.com </li>
...
<script>
    ...
    function initMap() {
        ...
        var image = 'Home/images/maps-and-flags.png';
